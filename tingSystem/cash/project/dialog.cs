...
namespace ting.cash.project
{
    public partial class dialog : EditDialog<Project>
    {
        public dialog()
        {
            InitializeComponent();
        ...
        protected override bool CheckValidity()
        {
            ...
            {
                withInfo.DisplayStatus("项目名称不能为空！", statusLabelInfo, false);
                return false;
            }
        ...
        protected override void BindingControls(Project entity)
        {
